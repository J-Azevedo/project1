classdef Word < handle
    ...
    methods
        ...
        function train(self, observations)
            ...
            for i = 1:15 %train for all records done
        ...
        function log_likelihood = em_step(self, observations)
            ...
            gamma_state_sum = sum(gamma, 2); %sums the columns of gamma
            ...
            expected_A_transpost = expected_A';
            expected_mu_transpost = expected_mu';
        end
